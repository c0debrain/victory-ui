angular.module('app.controllers')
    .controller('controllers.client', ClientController)
...
function ClientController(
    ...
    ClientManager.get($state.params.id).then(function(client) {
        $scope.client = client
        console.log('Datacenter: ', $scope.client)
        ...
        $scope.chartConfiguration.series.push({
            name: 'Performance',
            data: client.health.map(function(health) {
        ...
        $scope.chartConfiguration.xAxis.categories = client.health.map(function(health) {
