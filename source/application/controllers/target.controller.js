angular.module('app.controllers')
    .controller('controllers.target', TargetController)

TargetController.$inject = [
    '$scope',
    '$state',
    '$timeout',
    '$interval',
...
function TargetController(
    ...
    TargetManager.get($state.params.id).then(function(target) {
        $scope.target = target
        ...
        $scope.chartConfiguration.series.push({
            name: 'Performance',
            data: target.health.map(function(health) {
        ...
        $scope.chartConfiguration.xAxis.categories = target.health.map(function(health) {
